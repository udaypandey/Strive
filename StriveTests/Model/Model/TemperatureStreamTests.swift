...
class TemperatureStreamTests: XCTestCase {
    func testTemperatureStream() {
        guard let streams: [TemperatureStream] = model(from: "IntegerDataStreamTests") else {
