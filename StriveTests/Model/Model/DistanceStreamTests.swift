...
class DistanceStreamTests: XCTestCase {
    func testDistanceStream() {
        guard let streams: [DistanceStream] = model(from: "DistanceStreamTests") else {
