...
class SmoothGradeStreamTests: XCTestCase {
    func testSmoothGradeStream() {
        guard let streams: [SmoothGradeStream] = model(from: "FloatDataStreamTests") else {
