...
class AltitudeStreamTests: XCTestCase {
    func testAltitudeStream() {
        guard let streams: [AltitudeStream] = model(from: "FloatDataStreamTests") else {
