//
//  SmoothVelocityStreamTests.swift
//  StriveTests
//
...
class SmoothVelocityStreamTests: XCTestCase {
    func testSmoothVelocityStream() {
        guard let streams: [SmoothVelocityStream] = model(from: "FloatDataStreamTests") else {
